          ...
          <div className="h-full border rounded shadow-lg md:flex border-grey">
              ...
              >
                ...
                <div className="flex-1 px-4 overflow-auto bg-grey-lighter">
                  ...
                  {/* {allTeachers.map((teacher, index) => (
                                        <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer sm:pointer" onClick={() => handleTeacherClick(teacher)}>
                                            <div>
            ...
            {/* <div className={`md:w-2/3 border md:flex flex-col ${isOpen ? 'w-full h-full' : 'hidden'}`}>
                            ...
                            <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
                                <div className="flex items-center">
                                    <div>
                                        <img className="w-10 h-10 rounded-full" src="https://static.thenounproject.com/png/5034901-200.png" />
                                    </div>
                                    <div className="ml-4">
                                        <p className="text-grey-darkest">
                            ...
                            <div className="flex-1 overflow-auto bg-gray-200" >
                                <div className="py-2 px-3">
                                    ...
                                    <div className="flex justify-end mb-2">
                                        <div className="rounded py-2 px-3 bg-green-100">
                                            <p className="text-sm mt-1">
                                                Hi guys.
                                            </p>
                                            <p className="text-right text-xs text-grey-dark mt-1">
