  ...
  const deleteTeacher = async (e) => {
    ...
    try {
      ...
      const deleteCourse = await axios.delete(
        `https://api.mentorlanguageinstitute.com/api/admin-confi/delete-teacher/${teacherid}`,
    ...
    <>
      ...
      <div class=" grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-8 gap-8 mt-8">
        {filteredTeachers.map((teacher) => (
          <div href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-blue-600" title="View Profile">
            ...
            <div className='flex justify-between items-center '>
              ...
              <Link to={`/admin-dashboard/allteacher/${teacher?._id}`} className='text-sm  underline py-1 px-2 text-blue-500 text-sm rounded-md float-right'>View</Link>
        ...
        <div id="modelConfirm" className="fixed z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
          <div className="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div className="p-6 pt-0 text-center">
              ...
              <h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete this Teacher?</h3>
              <a href="#" onClick={deleteTeacher}
