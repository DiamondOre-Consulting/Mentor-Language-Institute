...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://api.mentorlanguageinstitute.com/api/admin-confi/signup-admin",
        formData
      );
  ...
  return (
    <>
      <div>
        <button onClick={openForm} className='bg-orange-400 rounded-md text-gray-50 p-2 float-right'>Add Admin</button>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          <div>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
              ...
              <div className="p-5">
                <a href="#">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">All Students</h5>
                </a>
                <p className="mb-3 font-normal text-gray-700">Total students: {allStudents.length}</p>
                <Link to='/admin-dashboard/allstudents' className="cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 rounded-lg hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
                  Explore More
          ...
          <div>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
              ...
              <div className="p-5">
                <a href="#">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">All Teachers</h5>
                </a>
                <p className="mb-3 font-normal text-gray-700">Total Teachers: {allTeachers.length}</p>
                <Link to='/admin-dashboard/allteachers' className="cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 rounded-lg hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
                  Explore More
                  <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                  </svg>
          ...
          <div>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
              ...
              <div className="p-5">
                <a href="#">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">All Courses</h5>
                </a>
                <p className="mb-3 font-normal text-gray-700">Total Courses: {allCourses.length}</p>
                <Link to='/admin-dashboard/allcourses' className="cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 rounded-lg hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
                  Explore More
                  <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                  </svg>
