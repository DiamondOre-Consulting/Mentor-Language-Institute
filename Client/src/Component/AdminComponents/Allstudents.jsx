        ...
        {filteredStudents.map((student) => (
          ...
          >
            ...
            <div className='flex justify-between mt-4'>
                <span className='text-sm bg-green-600 py-1 px-2 text-gray-100 rounded-md' onClick={() => openForm(student._id)}>Enroll </span>
                <span className='text-sm underline py-1 px-2 text-blue-500 text-sm rounded-md '>View</span>
