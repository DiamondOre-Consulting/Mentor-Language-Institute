...
const TeacherMessage = ({ teacherData }) => {
  ...
  const handleTeacherClick = (student) => {
    setSelectedTeacher(student); // Set selected teacher when clicked
              ...
              <div className={`md:w-1/3 border flex flex-col ${isSmallScreen && !isOpen ? 'w-full' : 'p-2'}`}>
                ...
                <div class="bg-grey-lighter flex-1 overflow-auto">
                  {studentDetail.map((student, index) => (
                    <div class="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer sm:pointer" onClick={() => handleTeacherClick(student)}>
                      <div>
