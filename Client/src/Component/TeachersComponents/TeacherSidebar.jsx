                ...
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 rounded-r-lg    ">
                    ...
                    <ul class="space-y-2 font-medium">
                        <li className=''>
                            ...
                            <Link to='/teacher-dashboard/teacher/home'
                        ...
                        <li>
                            <Link to='/teacher-dashboard/allstudents' href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-orange-500 group">
                        ...
                        <li>
                            <Link to='/admin-dashboard/allteachers' href="#" class="flex items-center hover:text-orange-500  p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">My Classes</span>
                            </Link>
                        </li>
