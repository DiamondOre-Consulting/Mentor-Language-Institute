...
const Login = () => {
    ...
    const handleAdminLogin = async (e) => {
        ...
        try {
            const response = await axios.post("http://192.168.29.235:7000/api/admin-confi/login-admin", {
                username,
                password
            });
            console.log("inside")
            ...
            const handleTeacherLogin = async (e) => {
                ...
                try {
                    const response = await axios.post("http://192.168.29.235:7000/api/teachers/login-teacher",
                        {
                            phone,
                            password
                        });
