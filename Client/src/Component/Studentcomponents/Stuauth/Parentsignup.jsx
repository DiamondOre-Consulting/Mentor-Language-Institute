    ...
    const handleStudentRegister = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://mentor-language-institute-backend.onrender.com/api/students/signup",
                {
                    name,
                    phone,
                    password,
                    ...
                    <div class="md:w-full sm:w-1/2 bg-white rounded-lg shadow border-t-4 border-orange-400 md:mt-0 sm:max-w-md xl:p-0">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" onSubmit={handleStudentRegister}>
                                ...
                                <a class="text-center flex items-center justify-center text-sm font-medium text-primary-600 ">Already Have Account? <Link to={'/student-login'} className='underline ml-1'>  Sign in</Link></a>
