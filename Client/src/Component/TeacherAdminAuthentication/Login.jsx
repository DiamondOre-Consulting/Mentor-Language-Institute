...
const Login = () => {
    ...
    const handleAdminLogin = async (e) => {
        ...
        try {
            const response = await axios.post("https://mentor-language-institute-backend-hbyk.onrender.com/api/admin-confi/login-admin", {
                username,
                password
            });
            // console.log("inside")
            ...
            const handleTeacherLogin = async (e) => {
                ...
                try {
                    const response = await axios.post("https://mentor-language-institute-backend-hbyk.onrender.com/api/teachers/login-teacher",
                        {
                            phone,
                            password
                        });
                                        ...
                                        <div class="flex flex-col items-center justify-center mt-16 lg:py-0 ">
                                            <div class="md:w-full sm:w-1/2 bg-white rounded-lg shadow-lg  md:mt-0 sm:max-w-md xl:p-0">
                                                <div className="flex space-x-4 md:space-x-10  ">
                                                    ...
                                                    <button
                                                        className={`py-2 px-4 md:px-10 border-b-2 ${activeTab === 0 ? 'border-orange-500' : 'border-transparent'} focus:outline-none`}
                                                        onClick={() => handleTabClick(0)}
                                                    >
                                                        Admin Login
                                                    </button>
                                                    <button
                                                        className={`py-2 px-4 md:px-10 border-b-2 ${activeTab === 1 ? 'border-orange-500' : 'border-transparent'} focus:outline-none`}
